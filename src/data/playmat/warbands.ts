...
export const playmatWarbands: PlaymatWarbandDef[] = [
  ...
  {
    id: "xandires-truthseekers",
    name: "Xandire's Truthseekers",
    fighters: [
      wuclubFighter("xandires-truthseekers", "xandire", "Xandire", 5),
      wuclubFighter("xandires-truthseekers", "dhoraz", "Dhoraz", 5),
      wuclubFighter("xandires-truthseekers", "luxa", "Luxa", 5),
      wuclubFighter("xandires-truthseekers", "taros", "Taros", 2)
    ]
  },
  {
